        ...
        {selectedProject ? (
          <div>
            ...
            <div style={{ border: "2px inset #808080", background: "#fff", padding: 10, marginBottom: 8 }}>
              ...
              <div style={{ lineHeight: 1.7 }}>{selectedProject.description}</div>
            </div>
            ...
            <div style={{ border: "2px inset #808080", background: "#fff", padding: 10, marginBottom: 8 }}>
              <table style={{ width: "100%", fontSize: 11, borderCollapse: "collapse" }}>
                <tbody>
                  <tr>
                    <td style={{ color: "#808080", paddingBottom: 4 }}>Views:</td>
                    <td style={{ fontWeight: "bold" }}>{selectedProject.view_count.toLocaleString()}</td>
                  </tr>
                  <tr>
                    <td style={{ color: "#808080", paddingBottom: 4 }}>Created:</td>
                    <td>{new Date(selectedProject.created_at).toLocaleDateString()}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {selectedProject.github_url && (
                <a href={selectedProject.github_url} target="_blank" rel="noreferrer">
                  <button className="win95-btn" style={{ fontSize: 11 }}>🐙 GitHub</button>
                </a>
              )}
              {selectedProject.live_url && (
                <a href={selectedProject.live_url} target="_blank" rel="noreferrer">
                  <button className="win95-btn" style={{ fontSize: 11 }}>🌐 Live Demo</button>
                </a>
              )}
            </div>
          </div>
